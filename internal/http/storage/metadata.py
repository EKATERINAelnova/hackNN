...
teacher = Table(
    "teacher", metadata,
    Column("id_teacher", Integer, primary_key=True),
    Column("name", String, nullable=False),
)

discipline = Table(
    "discipline", metadata,
    Column("id_discipline", Integer, primary_key=True),
    Column("name", String, nullable=False),
...
discipline_teacher = Table(
    ...
    Column("id_discipline_teacher", Integer, primary_key=True),
...
rating = Table(
    "rating", metadata,
    Column("id_rating", Integer, primary_key=True),
